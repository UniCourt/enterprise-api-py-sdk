...
class JudgeType(BaseModel):
    ...
    JudgeType
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=9, strict=True, max_length=9)]] = 'JudgeType'
    judge_type_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="judgeTypeId")
