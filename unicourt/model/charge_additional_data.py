...
class ChargeAdditionalData(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=20, strict=True, max_length=20)]] = 'ChargeAdditionalData'
    charge_additional_data_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="chargeAdditionalDataId")
