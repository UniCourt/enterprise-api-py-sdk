...
class CourtSystem(BaseModel):
    ...
    CourtSystem
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=11, strict=True, max_length=11)]] = 'CourtSystem'
    ...
    court_type: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, alias="courtType")
