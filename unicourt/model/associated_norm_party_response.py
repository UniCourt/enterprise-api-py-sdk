...
class AssociatedNormPartyResponse(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True, max_length=27)]] = 'AssociatedNormPartyResponse'
    ...
    __properties: ClassVar[List[str]] = ["object", "associatedNormPartyArray", "nextPageAPI", "previousPageAPI", "totalPages", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": obj.get("object") if obj.get("object") is not None else 'AssociatedNormPartyResponse',
