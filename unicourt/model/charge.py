...
class Charge(BaseModel):
    ...
    Charge
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=6, strict=True, max_length=6)]] = 'Charge'
    charge_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="chargeId")
    charge_group_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="chargeGroupId")
    charge_group: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, alias="chargeGroup")
