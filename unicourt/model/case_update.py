...
class CaseUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, case_id, status, requested_date, case_api, pacer_options, exception, case, *args, **kwargs):  # noqa: E501
        """CaseUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): Name of the object.. defaults to "CaseUpdate"  # noqa: E501
        ...
        object = kwargs.get('object', "CaseUpdate")
    ...
    @convert_js_args_to_python_args
    def __init__(self, case_id, status, requested_date, case_api, pacer_options, exception, case, *args, **kwargs):  # noqa: E501
        """CaseUpdate - a model defined in OpenAPI
