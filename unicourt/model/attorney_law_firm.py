...
class AttorneyLawFirm(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, attorney_law_firm_id, name, is_visible, first_fetch_date, last_fetch_date, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, attorney_law_firm_id, name, is_visible, first_fetch_date, last_fetch_date, *args, **kwargs):  # noqa: E501
        """AttorneyLawFirm - a model defined in OpenAPI
