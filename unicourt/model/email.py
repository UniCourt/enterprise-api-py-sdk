...
class Email(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=5, strict=True, max_length=5)]] = 'Email'
    email_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="email id", alias="emailId")
    is_visible: Optional[StrictBool] = Field(default=None, description="Boolean indicating if the email is visible or not.", alias="isVisible")
