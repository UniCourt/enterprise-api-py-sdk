...
class NormJudgePublicDataAbaRatings(BaseModel):
    ...
    """ # noqa: E501
    rating: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="rating")
    year: Optional[StrictInt] = Field(default=None, description="Year when Rating was recieved.")
