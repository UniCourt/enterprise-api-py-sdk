...
class ChargeDegree(BaseModel):
    ...
    ChargeDegree
    """ # noqa: E501
    object: Optional[Annotated[str, Field(min_length=12, strict=True, max_length=12)]] = 'ChargeDegree'
    charge_degree_id: Optional[Annotated[str, Field(min_length=18, strict=True, max_length=18)]] = Field(default=None, alias="chargeDegreeId")
