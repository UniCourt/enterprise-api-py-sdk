...
class ApiClient(object):
    ...
    def __call_api(
        ...
        if header_params:
            header_params = self.sanitize_for_serialization(header_params, method=method)
            header_params = dict(self.parameters_to_tuples(header_params,
                                                           collection_formats))

        # path parameters
        if path_params:
            path_params = self.sanitize_for_serialization(path_params, method=method)
        ...
        # query parameters
        if query_params:
            query_params = self.sanitize_for_serialization(query_params, method=method)
        ...
        if post_params or files:
            ...
            post_params = self.sanitize_for_serialization(post_params, method=method)
